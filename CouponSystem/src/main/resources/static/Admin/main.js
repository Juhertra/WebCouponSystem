...
module.exports = "@import url('https://fonts.googleapis.com/css?family=Nunito');\n\n@import url('https://fonts.googleapis.com/css?family=Poiret+One');\n\nbody {\n\theight: 100%;\n\tbackground-repeat: no-repeat;\n\t/*background-image: linear-gradient(rgb(12, 97, 33),rgb(104, 145, 162));*/\n\tbackground: black;\n\tposition: relative;\n}\n\n#company-box {\n\tposition: absolute;\n\ttop: 0px;\n\tleft: 50%;\n\t-webkit-transform: translateX(-50%);\n\t        transform: translateX(-50%);\n\twidth: 350px;\n\tmargin: 0 auto;\n\tborder: 1px solid black;\n\tbackground: rgba(48, 46, 45, 1);\n\tmin-height: 250px;\n\tpadding: 20px;\n\t/* z-index: 9999; */\n}\n\n#company-box .logo .logo-caption {\n\tfont-family: 'Poiret One', cursive;\n\tcolor: white;\n\ttext-align: center;\n\tmargin-bottom: 0px;\n}\n\n#company-box .logo .tweak {\n\tcolor: #ff5252;\n}\n\n#company-box .controls {\n\tpadding-top: 30px;\n}\n\n#company-box .controls input {\n\tborder-radius: 0px;\n\tbackground: rgb(98, 96, 96);\n\tborder: 0px;\n\tcolor: white;\n\tfont-family: 'Nunito', sans-serif;\n}\n\n#company-box .controls input:focus {\n\tbox-shadow: none;\n}\n\n#company-box .controls input:first-child {\n\tborder-top-left-radius: 2px;\n\tborder-top-right-radius: 2px;\n}\n\n#company-box .controls input:last-child {\n\tborder-bottom-left-radius: 2px;\n\tborder-bottom-right-radius: 2px;\n}\n\n#company-box button.btn-custom {\n\tborder-radius: 2px;\n\tmargin-top: 8px;\n\tbackground: #ff5252;\n\tborder-color: rgba(48, 46, 45, 1);\n\tcolor: white;\n\tfont-family: 'Nunito', sans-serif;\n}\n\n#company-box button.btn-custom:hover {\n\ttransition: all 500ms ease;\n\tbackground: rgba(48, 46, 45, 1);\n\tborder-color: #ff5252;\n}\n"
...
module.exports = "<body>\n\n  <div class=\"container\">\n    <div id=\"company-box\">\n      <div class=\"controls\">\n        <input type=\"text\" id=\"cname\" name=\"companyname\" placeholder=\"Company name\" [(ngModel)]=\"company.name\" class=\"form-control\" />\n        <input type=\"password\" id=\"companyPassword\" name=\"comppass\" placeholder=\"Password\" [(ngModel)]=\"company.password\"\n          class=\"form-control\" /> <input type=\"email\" id=\"cmail\" name=\"mail\" aria-describedby=\"emailHelp\" placeholder=\"E-mail\"\n          [(ngModel)]=\"company.email\" class=\"form-control\">\n        <button type=\"submit\" (click)=\"createCompany()\" class=\"btn btn-default btn-block btn-custom\">Create company</button>\n      </div>\n      <!-- /.controls -->\n    </div>\n    <!-- /#company-box -->\n  </div>\n  <!-- /.container -->\n\n</body>"
